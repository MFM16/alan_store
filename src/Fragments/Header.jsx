const Header = () => {
    return (
        <div className='w-full bg-primary text px-8 py-2 flex justify-start gap-2 items-center text-white'>
            <svg className="w-5 text-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className='font-bold text-xl text-white text'>
                Alan Resto
            </p>
        </div>
    )
