...
const Navbar = () => {
    ...
    return (
        <div className='w-full bg-white text px-8 flex justify-start gap-2 items-center shadow-md'>
            <Link to="/products" className={`px-5 py-2 font-semibold hover:text-primary hover:border-b-2 hover:border-primary ${location.pathname == '/products' ? 'active' : ''}`}>Food</Link>
